...
```shell script
git clone --branch <branch> --recursive https://github.com/yurisuika/spawn.git
...
Don't want to bother building from source? Get the releases *[right here](https://github.com/yurisuika/Spawn/releases)* now!
